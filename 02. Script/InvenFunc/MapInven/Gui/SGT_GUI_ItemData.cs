...
public class SGT_GUI_ItemData : MonoBehaviour
{
    ...
    public List<UnitDataTable> spriteDataSet = new();
...
public class ItemUnit
{
    ...
    public void InitData_Random_Slot(List<UnitDataTable> _dt, SlotGUI_InvenSlot _slot)
    {
        initData_Index();
        initData_ItemData();
    ...
    public void InitData_Random(List<UnitDataTable> _dt)
    {
        initData_Index();
        initData_ItemData();
        GoldValue = UnityEngine.Random.Range(50, 150);
